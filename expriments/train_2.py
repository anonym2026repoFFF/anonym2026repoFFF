...
from fastOPT_2 import FastOPT  # Ensure fastOPT.py is on your PYTHONPATH
...
def train(
    ...
    if full_config['model']['strategy'] in ['new_FFF', 'old_FFF' , 'new_moe']:
    ...
    if local_data_dir:
        ...
        if existing_ckpt is not None:
        ...
        elif from_scratch and (existing_ckpt is None) :
            ...
            print("Resuming training or fine-tuning from existing model...")
            model = FastOPT.from_pretrained(
                model_dir,
                depth=fff_depth,
                strategy=strategy,
    ...
    if hasattr(model.config, "attn_implementation"):
        print(f"Setting attn_implementation to flash_attention_2")
        model.config.attn_implementation = "flash_attention_2"  # or "sdpa"
    ...
    training_args = TrainingArguments(
        ...
        # fp16=fp16,
        bf16=fp16, fp16=False, tf32=True,  
        torch_compile=True, 
